...
public class GeoShapeOldGoogleMapActivity extends CollectAbstractActivity implements LocationListener,
    ...
    private void setupMap(GoogleMap googleMap) {
        ...
        layersButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                helper.showLayersDialog(GeoShapeOldGoogleMapActivity.this);
            }
        });
