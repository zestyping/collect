...
public class GeoTraceWidget extends QuestionWidget implements BinaryWidget {
    ...
    private void startGeoTraceActivity() {
        ...
        String mapSDK = prefs.getString(GeneralKeys.KEY_BASE_LAYER_TYPE, GeneralKeys.DEFAULT_BASEMAP_KEY);
        if (mapSDK.equals(GeneralKeys.BASE_LAYER_TYPE_GOOGLE) && !PlayServicesUtil.isGooglePlayServicesAvailable(getContext())) {
        ...
        Intent intent = new Intent(getContext(), GeoPolyActivity.class)
            ...
            .putExtra(GeneralKeys.KEY_BASE_LAYER_TYPE, mapSDK);
